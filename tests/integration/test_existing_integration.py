...
class TestExistingIntegrationScript(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_main_no_credentials(self, mock_input):
        ...
        with patch.dict(os.environ, {}, clear=True):
            ...
            with patch('builtins.print') as mock_print:
                ...
                error_found = any("No test credentials found" in call for call in print_calls)
    ...
    def test_constants_available(self):
        ...
        try:
            from test_integration import DOMAIN_INTERNATIONAL, DOMAIN_CHINA
